                    ...
                    <Formik>
                        <Form className=" space-y-3">
                            ...
                            <div className="w-full space-y-2">
                                ...
                                <Field className='px-3 py-2 rounded w-full border outline-[#FF6F61]' type="text" placeholder="Name" name='name' />
                                <ErrorMessage component='div' className="text-red-500" name="name" />
                            </div>
                            <div className="w-full space-y-2">
                                <label className="ml-1" htmlFor="">Email</label>
                                <Field className='px-3 py-2  border outline-[#FF6F61] rounded w-full' type="text" placeholder="Email Address" name='email' />
                                <ErrorMessage component='div' className="text-red-500" name="email" />
                            </div>
                            <div className="w-full space-y-2">
                                <label className="ml-1" htmlFor="">Phone</label>
                                <Field className='px-3 py-2  border outline-[#FF6F61] rounded w-full' type="number" placeholder="Phone Number" name='phone' />
                                <ErrorMessage component='div' className="text-red-500" name="phone" />
                            </div>
                            <div className="w-full space-y-2">
                                <label className="ml-1" htmlFor="">Message</label>
                                <Field className='px-3 py-2  border outline-[#FF6F61] rounded w-full' as="textarea" rows="4" placeholder="Let us know" name='message' />
                                <ErrorMessage component='div' className="text-red-500" name="message" />
                            </div>
                            <button className="w-full lg:w-[40%] px-4 py-2 bg-[#FF6F61] text-white">Send Message</button>
                        </Form>
                    </Formik>
                </div>
                ...
                <div className="w-full lg:w-[50%] lg:px-5">
                    <div className="w-full space-y-4">
                        ...
                        <div className="mt-5 w-full flex flex-row justify-start items-center gap-3">
                            <Link to={`https://www.facebook.com/miirshe`} target="_blank"><FaFacebook className="inline hover:text-[#FF6F61] transition-all ease-in-out" size={20} /></Link>
                            <Link to={`https://twitter.com/miirshe`} target="_blank"><FaTwitter className="inline hover:text-[#FF6F61] transition-all ease-in-out" size={20} /></Link>
                            <Link to={`https://www.instagram.com/miirshe`} target="_blank"><FaInstagram className="inline hover:text-[#FF6F61] transition-all ease-in-out" size={20} /></Link>
                            <Link to={`https://www.linkedin.com/in/miirshe`} target="_blank"><FaLinkedin className="inline hover:text-[#FF6F61] transition-all ease-in-out" size={20} /></Link>
                        </div>
                    </div>
                    <hr className="w-full mt-14" />
                    <div className="w-full mt-10 space-y-4">
                        <h1 className="text-2xl">Reach out to us</h1>
                        <p className=" text-base font-thin space-x-3"><MdOutlineEmail className="inline" size={25} /> <span>cazamart@gmail.com</span></p>
