    ...
    return (
        <div className="w-full p-3">
            ...
            <div className="w-full space-y-8 mt-10">
                <div className="p-2">
                    <p className="text-base font-normal text-justify"> <span className="text-[#FF6F61] font-bold">CAZAMART</span> is an e-commerce platform that offers a wide range of products to customers,
                ...
                <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div className="w-full p-2 space-y-4">
                        <h1 className="text-2xl tracking-widest text-[#FF6F61] font-bold">Vission</h1>
                    ...
                    <div className="w-full p-2 space-y-4">
                        <h1 className="text-2xl tracking-widest text-[#FF6F61] font-bold">Mission</h1>
                        <p className="text-base font-normal text-justify">
